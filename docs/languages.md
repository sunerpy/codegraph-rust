...
| Python      | `.py` `.pyw`                                | Full tree-sitter          | Bare class names used as values resolve to `References` edges in return, assignment, pair, argument, and list positions. Tuple returns are not recursively traversed, and bare names never resolve to methods; methods require a receiver.                                                                                                                                                                                      |
